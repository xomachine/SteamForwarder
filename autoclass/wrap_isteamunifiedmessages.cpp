...
{
  TRACE("((ISteamUnifiedMessages *)%p, (ClientUnifiedMessageHandle )%p, (uint32 *)%p, (EResult *)%p)\n", this, hHandle, punResponseSize, peResult);
...
{
  TRACE("((ISteamUnifiedMessages *)%p, (ClientUnifiedMessageHandle )%p, (void *)%p, (uint32 )%p, (bool )%d)\n", this, hHandle, pResponseBuffer, unResponseBufferSize, bAutoRelease);
