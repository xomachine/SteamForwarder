#ifndef WRAP_ISTEAMAPPLIST_H
#define WRAP_ISTEAMAPPLIST_H
#include "steam_api.h"
class ISteamAppList_ 
{
  ...
  virtual int GetAppName( AppId_t nAppID, OUT_STRING() char *pchName, int cchNameMax ) __attribute__((thiscall));
