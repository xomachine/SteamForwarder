#ifndef WRAP_ISTEAMNETWORKING_CPP
#define WRAP_ISTEAMNETWORKING_CPP
#include "autoclass/steam_api_.h" 
#include "windef.h"
#include "wine/debug.h"
#include "config.h"
bool ISteamNetworking_::SendP2PPacket( CSteamID steamIDRemote, const void *pubData, uint32 cubData, EP2PSend eP2PSendType, int nChannel = 0 )
{
  TRACE("((this[ISteamNetworking])%p, (CSteamID)%p, (const void *)%p, (uint32)%d, (EP2PSend)%p, (int)%d)\n", this, steamIDRemote, pubData, cubData, eP2PSendType, nChannel);
  bool result = this->internal->SendP2PPacket(steamIDRemote, pubData, cubData, eP2PSendType, nChannel);
  TRACE(" = (bool)%d\n", result);
  return result;
}
bool ISteamNetworking_::IsP2PPacketAvailable( uint32 *pcubMsgSize, int nChannel = 0 )
{
  TRACE("((this[ISteamNetworking])%p, (uint32 *)%p, (int)%d)\n", this, pcubMsgSize, nChannel);
  bool result = this->internal->IsP2PPacketAvailable(pcubMsgSize, nChannel);
  TRACE(" = (bool)%d\n", result);
  return result;
}
bool ISteamNetworking_::ReadP2PPacket( void *pubDest, uint32 cubDest, uint32 *pcubMsgSize, CSteamID *psteamIDRemote, int nChannel = 0 )
{
  TRACE("((this[ISteamNetworking])%p, (void *)%p, (uint32)%d, (uint32 *)%p, (CSteamID *)%p, (int)%d)\n", this, pubDest, cubDest, pcubMsgSize, psteamIDRemote, nChannel);
...
{
  TRACE("((this[ISteamNetworking])%p, (CSteamID)%p)\n", this, steamIDRemote);
...
{
  TRACE("((this[ISteamNetworking])%p, (CSteamID)%p, (int)%d)\n", this, steamIDRemote, nChannel);
...
{
  TRACE("((this[ISteamNetworking])%p, (CSteamID)%p, (P2PSessionState_t *)%p)\n", this, steamIDRemote, pConnectionState);
...
{
  TRACE("((this[ISteamNetworking])%p, (bool)%d)\n", this, bAllow);
...
{
  TRACE("((this[ISteamNetworking])%p, (int)%d, (uint32)%d, (uint16)%d, (bool)%d)\n", this, nVirtualP2PPort, nIP, nPort, bAllowUseOfPacketRelay);
...
{
  TRACE("((this[ISteamNetworking])%p, (uint32)%d, (uint16)%d, (int)%d)\n", this, nIP, nPort, nTimeoutSec);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p, (bool)%d)\n", this, hSocket, bNotifyRemoteEnd);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetListenSocket_t)%p, (bool)%d)\n", this, hSocket, bNotifyRemoteEnd);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p, (void *)%p, (uint32)%d, (bool)%d)\n", this, hSocket, pubData, cubData, bReliable);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p, (uint32 *)%p)\n", this, hSocket, pcubMsgSize);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p, (void *)%p, (uint32)%d, (uint32 *)%p)\n", this, hSocket, pubDest, cubDest, pcubMsgSize);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetListenSocket_t)%p, (uint32 *)%p, (SNetSocket_t *)%p)\n", this, hListenSocket, pcubMsgSize, phSocket);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetListenSocket_t)%p, (void *)%p, (uint32)%d, (uint32 *)%p, (SNetSocket_t *)%p)\n", this, hListenSocket, pubDest, cubDest, pcubMsgSize, phSocket);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p, (CSteamID *)%p, (int *)%p, (uint32 *)%p, (uint16 *)%p)\n", this, hSocket, pSteamIDRemote, peSocketStatus, punIPRemote, punPortRemote);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetListenSocket_t)%p, (uint32 *)%p, (uint16 *)%p)\n", this, hListenSocket, pnIP, pnPort);
...
{
  TRACE("((this[ISteamNetworking])%p, (SNetSocket_t)%p)\n", this, hSocket);
