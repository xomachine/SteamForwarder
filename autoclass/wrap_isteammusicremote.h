...
{
public:
  virtual bool  RegisterSteamMusicRemote(char * pchName) __attribute__((thiscall));
  ...
  virtual bool  SetDisplayName(char * pchDisplayName) __attribute__((thiscall));
  ...
  virtual bool  UpdateCurrentEntryText(char * pchText) __attribute__((thiscall));
  ...
  virtual bool  SetQueueEntry(int  nID, int  nPosition, char * pchEntryText) __attribute__((thiscall));
  ...
  virtual bool  SetPlaylistEntry(int  nID, int  nPosition, char * pchEntryText) __attribute__((thiscall));
  virtual bool  SetCurrentPlaylistEntry(int  nID) __attribute__((thiscall));
  virtual bool  PlaylistDidChange() __attribute__((thiscall));
  ISteamMusicRemote_(ISteamMusicRemote*to_wrap);
  ~ISteamMusicRemote_();
private:
