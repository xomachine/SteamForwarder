...
{
  TRACE("((ISteamGameCoordinator *)%p, (uint32 )%p, (void *)%p, (uint32 )%p)\n", this, unMsgType, pubData, cubData);
...
{
  TRACE("((ISteamGameCoordinator *)%p, (uint32 *)%p)\n", this, pcubMsgSize);
...
{
  TRACE("((ISteamGameCoordinator *)%p, (uint32 *)%p, (void *)%p, (uint32 )%p, (uint32 *)%p)\n", this, punMsgType, pubDest, cubDest, pcubMsgSize);
