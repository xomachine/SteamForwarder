#ifndef WRAP_ISTEAMCONTROLLER_H
#define WRAP_ISTEAMCONTROLLER_H
#include "steam_api.h"
class ISteamController_ 
{
  ...
  virtual ControllerActionSetHandle_t GetActionSetHandle( const char *pszActionSetName ) __attribute__((thiscall));
  ...
  virtual ControllerDigitalActionHandle_t GetDigitalActionHandle( const char *pszActionName ) __attribute__((thiscall));
  ...
  virtual ControllerAnalogActionHandle_t GetAnalogActionHandle( const char *pszActionName ) __attribute__((thiscall));
  ...
  virtual void TriggerRepeatedHapticPulse( ControllerHandle_t controllerHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec, unsigned short usOffMicroSec, unsigned short unRepeat, unsigned int nFlags ) __attribute__((thiscall));
  ...
  virtual void SetLEDColor( ControllerHandle_t controllerHandle, uint8 nColorR, uint8 nColorG, uint8 nColorB, unsigned int nFlags ) __attribute__((thiscall));
  ...
  virtual const char * GetStringForActionOrigin( EControllerActionOrigin eOrigin ) __attribute__((thiscall));
  virtual const char * GetGlyphForActionOrigin( EControllerActionOrigin eOrigin ) __attribute__((thiscall));
  public:
